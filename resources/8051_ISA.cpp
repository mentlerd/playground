...
static constexpr std::array g_opcodes = {
	...
	Opcode{"CJNE @Ri,#data,rel", "Ri[0] 1101101; data[0-7]; rel[0-7];"},
	...
	Opcode{"MOV direct,@Ri",     "Ri[0]; 1100001; direct[0-7];"},
	Opcode{"MOV direct,#data",   "10101110; direct[0-7]; data[0-7];"},
	Opcode{"MOV @Ri,A",          "Ri[0] 1101111;"},
	Opcode{"MOV @Ri,direct",     "Ri[0] 1100101; direct[0-7];"},
	Opcode{"MOV @Ri,#data",      "Ri[0] 1101110; data[0-7];"},
	...
	Opcode{"XCH A,@Ri",          "Ri[0] 1100011;"},
	Opcode{"XCHD A,@Ri",         "Ri[0] 1101011;"},
	Opcode{"XRL A,Rn",           "Rn[0-2] 10110;"},
	Opcode{"XRL A,direct",       "10100110; direct[0-7];"},
	Opcode{"XRL A,@Ri",          "Ri[0] 1100110;"},
