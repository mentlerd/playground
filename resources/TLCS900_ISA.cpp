...
static constexpr std::array g_opcodes = {
	...
	// TODO: General support for extension codes/memory access specifiers as described below

	// 'r' extension code format
	// 1110 z[0-1] 11; r[0-7]; R[0-2] 01001;

	// Memory addressing mode specify codes
	// (XWA)     0000--0-; 
	// (XBC)     1000--0-; 
	// (XDE)     0100--0-; 
	// (XHL)     1100--0-; 
	...
	// (#16)     1000--1-; #16[0-15];
	// (#24)     0100--1-; #24[0-24];
	// (r32)     1100--1-; 00 r32'[0-5];
	// (r32+d16) 1100--1-; 10 r32'[0-5]; d[0-15];
	// (r32+d8)  1100--1-; 11 000000; r32[0-7]; r8[0-7];
	// (r32+r16) 1100--1-; 11 100000; r32[0-7]; r8[0-7];
	// (-r32)    0010--1-; z[0-1] r32'[0-5];
	// (r32+)    1010--1-; z[0-1] r32'[0-5];
